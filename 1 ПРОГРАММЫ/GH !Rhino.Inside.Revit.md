...
CLASS: -10 ПРОГРАММЫ
TYPE: GRASSSHOPPER
SubTYPE: Rhino.Inside.Revit
cover: "![[Pasted image 20241227155625.png|200]]"
note: LINK между REVIT и RHINO в плагине Grasshopper
...
TABLE
	...
	tags as "Tags",
	cover as "Cover"
WHERE CLASS = "-10 ПРОГРАММЫ" where TYPE = "GRASSSHOPPER" where  SubTYPE = "Rhino.Inside.Revit" 
SORT published
```
- 
---
...
- *МАТЕРИАЛЫ*
---
- [b] [Rhino.Inside.Revit DOWNLOAD](https://www.rhino3d.com/inside/revit/1.0/) 

- [i] [Rhino.Inside.Revit GUIDES](https://www.rhino3d.com/inside/revit/1.0/guides/)
...
---
- **LINK:**
	- [i] [Importing Geometry using Rhino Inside Revit](https://youtu.be/W5xLkt7ucI0?si=g4WV-w0MT4wSH-VF)

---
## **IMPORT**
- **IMPORT**
### IMPORT **GRASSHOPPER** to **REVIT**
- IMPORT **GRASSHOPPER** to **REVIT**
---
- Простой импорт: ![[Pasted image 20241227160927.png]]


---
# Desk - GH !Rhino.Inside.Revit

![[GH !Rhino.Inside.Revit.svg]]
%%
# Excalidraw Data
## Text Elements
BACKLOG ^irN3rVwb
