...
- ТЕКСТ *Контейнер*
---
- [Размеры контейнера текста](https://www.loom.com/share/3b943d60a5bf415fad93c3c28b99aef5)

---
## **НАВИГАЦИЯ**
- **НАВИГАЦИЯ**
---
- *зажать* **Alt** <- можно просто менять в свойствах размеры

---
## **ВЫРАВНИВАНИЕ**
- **ВЫРАВНИВАНИЕ**
---
- *Выделить объекты* -> *Применить выравнивание (Position)* -> *Три точки* -> *Tidy up*
	- для быстрого выравнивания и быстрое задание отступов
- *два раза щёлкнуть на контейнер текста* <- обрезка по тексту
