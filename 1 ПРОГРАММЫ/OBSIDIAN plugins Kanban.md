---
DATE: 2024-10-28 11:17
CLASS: -10 ПРОГРАММЫ
TYPE: OBSIDIAN
SubTYPE: kanban
cover: 
note: Доска задач - новые задачи/файл
...
## ОБУЧЕНИЕ
- [YouTube - How I use Kanban in Obsidian](https://youtu.be/13mElDSs0a8?si=2dfXlskGvijrTVcy)

## TIPS
-  `Edit list` -> в скобках написать максимальное количество карточек
	![[Pasted image 20241028111702.png]]
-  цвет тегов
	![[Pasted image 20241028112128.png]]


---
# Desk - OBSIDIAN plugins Kanban

![[OBSIDIAN plugins Kanban.svg]]
%%
# Excalidraw Data
## Text Elements
BACKLOG ^irN3rVwb
