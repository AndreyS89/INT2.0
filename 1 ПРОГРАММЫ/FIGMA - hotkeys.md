...
TABLE
	...
	tags as "Tags",
	cover as "Cover"
WHERE CLASS = "-10 ПРОГРАММЫ" where TYPE = "FIGMA" where  SubTYPE = "general" 
SORT published
```
- [[!30 ДИЗАЙН]]
---
# [[FIGMA - hotkeys]]
## ИНСТРУМЕНТЫ
- **V** <- стандартный инструмент выделения
- **F** <- выбрать инструмент для создания фреймов
- **P** <- выбрать перо
- **Shift + P** <- выбрать карандаш
- **T** <- выбрать текст
- **R** <- выбрать прямоугольник
- **O** <- выбрать эллипс
- **L** <- выбрать линию
- **Shift + L** <- выбрать стрелку
- **C** <- добавить или показать комментарии
- **Ctrl + C** <- выбрать пипетку
## image - hotkeys

![[Pasted image 20241128080426.png]]

## image - examples
![[Pasted image 20241128083027.png]]

![[Pasted image 20241128083042.png]]

![[Pasted image 20241128083128.png]]

![[Pasted image 20241128083142.png]]

![[Pasted image 20241128083151.png]]

![[Pasted image 20241128083201.png]]

![[Pasted image 20241128083221.png]]

![[Pasted image 20241128083227.png]]
