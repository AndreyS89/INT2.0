...
---
# [[1 ПРОГРАММЫ/!FEATHER|FEATHER 3D]]
## _table
```dataview
TABLE
	note as "Примечание",
	tags as "Tags",
	cover as "Cover"
WHERE CLASS = "-10 ПРОГРАММЫ" where SubTYPE = "FEATHER" where TYPE != "GENERAL"
SORT published
```
- 
---
...
### Управление
#### навигация
- `2 касания` **1 пальцем** - выравнивание вида
- `2 касания` **3 пальцами** - ортогональный вид / перспектива
	- `2 касания` **3 пальцами** *↑ ↓* - глубина камеры
---
# Desk - Untitled
